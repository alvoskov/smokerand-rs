...
/// Keeps information about available and total amounts of physical RAM.
...
/// Pointers to the API functions used by a caller, i.e. PRNG
...
/// Extend CallerAPI by safe methods
impl CallerAPI {
    /// Get 128-bit seed
...
/// Keeps the description of pseudorandon number generator.
